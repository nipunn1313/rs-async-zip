...
compressed_test_helper!(
    deflate_test, Compression::Deflate, "foo bar", include_bytes!("../../../data/compression/deflate.data")
);

#[cfg(feature = "bzip2")]
compressed_test_helper!(
    bz_test, Compression::Bz, "foo bar", include_bytes!("../../../data/compression/bzip2.data")
);

#[cfg(feature = "lzma")]
compressed_test_helper!(
    lzma_test, Compression::Lzma, "foo bar", include_bytes!("../../../data/compression/lzma.data")
);

#[cfg(feature = "zstd")]
compressed_test_helper!(
    zstd_test, Compression::Zstd, "foo bar", include_bytes!("../../../data/compression/zstd.data")
);

#[cfg(feature = "xz")]
compressed_test_helper!(
    xz_test, Compression::Xz, "foo bar", include_bytes!("../../../data/compression/xz.data")
);
